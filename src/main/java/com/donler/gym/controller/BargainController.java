...
import com.donler.gym.service.TokenServcie;
...
public class BargainController {
  ...
  public ResponseEntity<Bargain> saveBargainInfo(@RequestHeader(value = "x-token", required = true) String token, @Valid @RequestBody Bargain input) {
    User user = tokenServcie.getUserFromCheckingToken(token);
  ...
  @ApiOperation(value = "获取某一销售员的所有合同", notes = "通过token判断身份,获取某一销售员的所签售的所有合同")
